        ...
        <Row gutter={[16, 16]}>
            ...
            <Col span={19}>
                <div className={'flex justify-between items-center mb-1'}><h3 className={'font-bold'}>Detailed Room
                    Images</h3>
                    <Upload disabled={images.length >= 4} className={'mt-4'} onChange={handleChangeDetails} showUploadList={false}>
                        <Button icon={<UploadOutlined/>}>
                            Add Image
                        </Button>
                    </Upload>
                ...
                <div className={'grid grid-cols-4 gap-4'}>
                    {images?.slice(0, 4).map((image: string, index: number) => <div><Image
...
function BedDialog({isModalOpen, setIsModalOpen,beds, setBeds}: { isModalOpen: boolean, setIsModalOpen: any,beds: any, setBeds: any }) {
