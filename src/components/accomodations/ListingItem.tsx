...
export default function ListingItem({stay}: { stay: any }) {
    ...
    return <Link href={`/accomodations/${stay.id}`} className={'block text-dark rounded-lg '}>
        <img alt={stay.name} src={stay.poster} className={'aspect-square object-cover rounded-lg w-full mb-2'} />
